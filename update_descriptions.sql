-- =============================================================
-- HidroG - Atualização de descrições dos produtos reais
-- Extraído automaticamente do site atual em lojaintegrada.com.br
-- =============================================================

update products set description = '<p>Bomba Submersa Ebara 3" 3BPS2-14 0,75 CV </p>
...
<p> </p>' where slug = 'bomba-submersa-ebara-4bpl3-10';
update products set description = '<p>Bomba Submersa Ebara 3" 3BPS2-10 0,50 CV </p>
...
<p> </p>' where slug = 'bomba-submersa-ebara-4bpl6-08';
update products set description = '<p><strong>Bomba Submersa Leão 6" R11A-09 6CV 220/380 TRIF s600</strong></p>
...
<p>As vazões acima descritas correspondem aos respectivos níveis dinâmicos e não ao ponto de instalação da bomba. Portanto, quando se basear pelo ponto de instalação, as vazões serão MAIORES que as descritas, considerando que o poço consiga produzir a quantidade de água extraída.<br />
<br />
Nível dinâmico: Nível de água do poço com a bomba ligada.</p>' where slug = 'bomba-submersa-leao-r11a-07-600';
update products set description = '<p>Bomba Submersa Ebara 3" 3BPS2-07 0,33 CV 220V</p>
...
<p> </p>' where slug = 'bomba-submersa-leao-3r3pb-18-180';
update products set description = '<p>Bomba Submersa Leão 4 Polegadas 230 4R3PA-11 1 CV 220V</p>
...
<p>As vazões acima descritas correspondem aos respectivos níveis dinâmicos e não ao ponto de instalação da bomba. Portanto, quando se basear pelo ponto de instalação, as vazões serão MAIORES que as descritas, considerando que o poço consiga produzir a quantidade de água extraída.<br />
<br />
Nível dinâmico: Nível de água do poço com a bomba ligada.</p>' where slug = 'bomba-submersa-leao-4r4pa-08-230';
update products set description = '<p>Bomba Submersa Ebara 3" 3BPS2-07 0,33 CV 220V</p>
...
<p> </p>' where slug = 'bomba-submersa-leao-3r3pb-09-180';
update products set description = '<p>Bomba Submersa Ebara 3" 3BPS2-07 0,33 CV 220V</p>
...
<p> </p>' where slug = 'bomba-submersa-leao-3r3pb-13-180';
update products set description = '<p>Bomba Submersa Ebara 3" 3BPS2-07 0,33 CV 220V</p>
...
<p> </p>' where slug = 'bomba-submersa-vibratoria-anauger-6';
update products set description = '<p><strong>Bomba Submersa Leão 4" 230 4R5PA-18 3CV 220v</strong></p>
...
<p>As vazões acima descritas correspondem aos respectivos níveis dinâmicos e não ao ponto de instalação da bomba. Portanto, quando se basear pelo ponto de instalação, as vazões serão MAIORES que as descritas, considerando que o poço consiga produzir a quantidade de água extraída.<br />
<br />
Nível dinâmico: Nível de água do poço com a bomba ligada.</p>' where slug = 'bomba-submersa-leao-4r5pa-12-230';
update products set description = '<p><strong>Bomba Submersa Leão 4" 370 4R5PA-09 1,5 CV 220V</strong></p>
...
<p>As vazões acima descritas correspondem aos respectivos níveis dinâmicos e não ao ponto de instalação da bomba. Portanto, quando se basear pelo ponto de instalação, as vazões serão MAIORES que as descritas, considerando que o poço consiga produzir a quantidade de água extraída.<br />
<br />
Nível dinâmico: Nível de água do poço com a bomba ligada.</p>' where slug = 'bomba-submersa-leao-4r5pa-09-230';
update products set description = '<p>Bomba Submersa Leão 4 Polegadas 230 4R3PA-11 1 CV 220V</p>
...
<p>As vazões acima descritas correspondem aos respectivos níveis dinâmicos e não ao ponto de instalação da bomba. Portanto, quando se basear pelo ponto de instalação, as vazões serão MAIORES que as descritas, considerando que o poço consiga produzir a quantidade de água extraída.<br />
<br />
Nível dinâmico: Nível de água do poço com a bomba ligada.</p>' where slug = 'bomba-submersa-leao-4r4pa-10-230';
update products set description = '<p>Bomba Submersa Leão 4 Polegadas 230 4R3PA-11 1 CV 220V</p>
...
<p>As vazões acima descritas correspondem aos respectivos níveis dinâmicos e não ao ponto de instalação da bomba. Portanto, quando se basear pelo ponto de instalação, as vazões serão MAIORES que as descritas, considerando que o poço consiga produzir a quantidade de água extraída.<br />
<br />
Nível dinâmico: Nível de água do poço com a bomba ligada.</p>' where slug = 'bomba-submersa-leao-4r3pa-07-230';
update products set description = '<p><strong>Bomba Submersa Leão 4" 230 4R5PA-18 3CV 220v</strong></p>
...
<p>As vazões acima descritas correspondem aos respectivos níveis dinâmicos e não ao ponto de instalação da bomba. Portanto, quando se basear pelo ponto de instalação, as vazões serão MAIORES que as descritas, considerando que o poço consiga produzir a quantidade de água extraída.<br />
<br />
Nível dinâmico: Nível de água do poço com a bomba ligada.</p>' where slug = 'bomba-submersa-leao-4r5pa-18-230';
update products set description = '<p><strong>Bomba Submersa Leão 4" 370 4R5PA-12 2CV 220V</strong></p>
...
<p>As vazões acima descritas correspondem aos respectivos níveis dinâmicos e não ao ponto de instalação da bomba. Portanto, quando se basear pelo ponto de instalação, as vazões serão MAIORES que as descritas, considerando que o poço consiga produzir a quantidade de água extraída.<br />
<br />
Nível dinâmico: Nível de água do poço com a bomba ligada.</p>' where slug = 'bomba-submersa-leao-4r5pa-12-370';
update products set description = '<p><strong>Bomba Submersa Leão 4" 370 4R5PA-12 2CV 220V</strong></p>
...
<p>As vazões acima descritas correspondem aos respectivos níveis dinâmicos e não ao ponto de instalação da bomba. Portanto, quando se basear pelo ponto de instalação, as vazões serão MAIORES que as descritas, considerando que o poço consiga produzir a quantidade de água extraída.<br />
<br />
Nível dinâmico: Nível de água do poço com a bomba ligada.</p>' where slug = 'bomba-submersa-leao-4r5pa-09-370';
update products set description = '<p><strong>Bomba Submersa Leão 6" R20A-09 9CV 220/380 TRIF S600</strong></p>
...
<p>As vazões acima descritas correspondem aos respectivos níveis dinâmicos e não ao ponto de instalação da bomba. Portanto, quando se basear pelo ponto de instalação, as vazões serão MAIORES que as descritas, considerando que o poço consiga produzir a quantidade de água extraída.<br />
<br />
Nível dinâmico: Nível de água do poço com a bomba ligada.</p>' where slug = 'bomba-submersa-leao-r20a-08-610';
update products set description = '<p><strong>Bomba Submersa Leão 6" R20A-08 8CV 220/380 TRIF S600</strong></p>
...
<p>As vazões acima descritas correspondem aos respectivos níveis dinâmicos e não ao ponto de instalação da bomba. Portanto, quando se basear pelo ponto de instalação, as vazões serão MAIORES que as descritas, considerando que o poço consiga produzir a quantidade de água extraída.<br />
<br />
Nível dinâmico: Nível de água do poço com a bomba ligada.</p>' where slug = 'bomba-submersa-leao-r20a-09-600';
update products set description = '<p><strong>Bomba Submersa Leão 6" R20A-09 9CV 220/380 TRIF S600</strong></p>
...
<p>As vazões acima descritas correspondem aos respectivos níveis dinâmicos e não ao ponto de instalação da bomba. Portanto, quando se basear pelo ponto de instalação, as vazões serão MAIORES que as descritas, considerando que o poço consiga produzir a quantidade de água extraída.<br />
<br />
Nível dinâmico: Nível de água do poço com a bomba ligada.</p>' where slug = 'bomba-submersa-leao-r20a-07-600';
update products set description = '<p><strong>Bomba Submersa Leão 6" R11A-09 6CV 220/380 TRIF s600</strong></p>
...
<p>As vazões acima descritas correspondem aos respectivos níveis dinâmicos e não ao ponto de instalação da bomba. Portanto, quando se basear pelo ponto de instalação, as vazões serão MAIORES que as descritas, considerando que o poço consiga produzir a quantidade de água extraída.<br />
<br />
Nível dinâmico: Nível de água do poço com a bomba ligada.</p>' where slug = 'bomba-submersa-leao-r11a-11-500';
update products set description = '<p><strong>Bomba Submersa Leão 6" R11A-09 6CV 220/380 TRIF s600</strong></p>
...
<p>As vazões acima descritas correspondem aos respectivos níveis dinâmicos e não ao ponto de instalação da bomba. Portanto, quando se basear pelo ponto de instalação, as vazões serão MAIORES que as descritas, considerando que o poço consiga produzir a quantidade de água extraída.<br />
<br />
Nível dinâmico: Nível de água do poço com a bomba ligada.</p>' where slug = 'bomba-submersa-leao-r11a-14-610';
update products set description = '<p><strong>Bomba Submersa Leão 6" R11A-09 6CV 220/380 TRIF s600</strong></p>
...
<p>As vazões acima descritas correspondem aos respectivos níveis dinâmicos e não ao ponto de instalação da bomba. Portanto, quando se basear pelo ponto de instalação, as vazões serão MAIORES que as descritas, considerando que o poço consiga produzir a quantidade de água extraída.<br />
<br />
Nível dinâmico: Nível de água do poço com a bomba ligada.</p>' where slug = 'bomba-submersa-leao-r11a-10-600';
update products set description = '<p><strong>Bomba Submersa Leão 6" R11A-10 6,5CV 220/380 TRIF s600</strong></p>
...
<p>As vazões acima descritas correspondem aos respectivos níveis dinâmicos e não ao ponto de instalação da bomba. Portanto, quando se basear pelo ponto de instalação, as vazões serão MAIORES que as descritas, considerando que o poço consiga produzir a quantidade de água extraída.<br />
<br />
Nível dinâmico: Nível de água do poço com a bomba ligada.</p>' where slug = 'bomba-submersa-leao-r11a-09-600';
update products set description = '<p>Bomba Submersa Leão 4 Polegadas 230 4R3PA-11 1 CV 220V</p>
...
<p>As vazões acima descritas correspondem aos respectivos níveis dinâmicos e não ao ponto de instalação da bomba. Portanto, quando se basear pelo ponto de instalação, as vazões serão MAIORES que as descritas, considerando que o poço consiga produzir a quantidade de água extraída.<br />
<br />
Nível dinâmico: Nível de água do poço com a bomba ligada.</p>' where slug = 'bomba-submersa-leao-4r3pa-11-230';
update products set description = '<p>Bomba Submersa Ebara 3" 3BPS2-14 0,75 CV </p>
...
<p> </p>' where slug = 'bomba-submersa-ebara-3bps2-14';
update products set description = '<p>Bomba Submersa Ebara 3" 3BPS2-14 0,75 CV </p>
...
<p> </p>' where slug = 'bomba-submersa-ebara-3bps2-10';
update products set description = '<p>Bomba Submersa Ebara 3" 3BPS2-10 0,50 CV </p>
...
<p> </p>' where slug = 'bomba-submersa-ebara-3bps2-07';
update products set description = '<p>Aplicações Gerais</p>
...
<p>• Profundidade de imersão máxima: 7 metros</p>' where slug = 'bomba-drenagem-schneider-lup-05';
update products set description = '<p><strong>Cabo PP Flexível 2x2.5mm Condumig</strong></p>
...
<p>Marca Condumig</p>' where slug = 'cabo-pp-flexivel-3x6mm-condumig';
update products set description = '<p><strong>Cabo PP Flexível 3x6mm Condumig</strong></p>
...
<p>Marca Condumig</p>' where slug = 'cabo-pp-flexivel-3x4mm-condumig';
update products set description = '<p><strong>Cabo PP Flexível 2x2.5mm Condumig</strong></p>
...
<p>Marca Condumig</p>' where slug = 'cabo-pp-flexivel-3x2-5mm-condumig';
update products set description = '<p><strong>Cabo PP Flexível 2x2.5mm Condumig</strong></p>
...
<p>Marca Condumig</p>' where slug = 'cabo-pp-flexivel-2x2-5mm-condumig';
update products set description = '<p style="margin: 0px 0px 10px; padding: 0px; color: rgb(102, 102, 102); font-family: Arial, Helvetica, sans-serif; font-size: 12px;"><strong style="margin: 0px; padding: 0px;">--APLICAÇÕES GERAIS</strong></p>
...
<p> </p>' where slug = 'luva-galvanizada-tupy';
update products set description = '<p>Abraçadeira Reforçada para Mangueira Fundição Medeiros </p>
...
<p> </p>' where slug = 'abracadeira-metal-reforcada-p-mangueira';
update products set description = '<p>Adaptado P/ Mangueira Macho Escama x Rosca BSP - Ferro Fundido </p>
...
<p> </p>' where slug = 'adaptado-p-mangueira-macho-escama-bsp-ferro-fundido';
update products set description = '<p>REGISTRO ESFERA MIPEL METAL  BSP</p>
...
Vedações: PTFE.</p>' where slug = 'valvula-esfera-monobloco-latao-niquelado-mipel';
update products set description = '<p style="margin: 0px 0px 10px; padding: 0px; color: rgb(102, 102, 102); font-family: Arial, Helvetica, sans-serif; font-size: 12px;"><strong style="margin: 0px; padding: 0px;">--APLICAÇÕES GERAIS</strong></p>
...
<p style="margin: 0px 0px 10px; padding: 0px; color: rgb(102, 102, 102); font-family: Arial, Helvetica, sans-serif; font-size: 12px;"> </p>' where slug = 'painel-comando-completo-trifasico-220v';
update products set description = '<p>TAMPA PARA POÇO 125mm INTERNO.</p>
...
<p>FURO: 1 1/2"  MAX 49mm</p>' where slug = 'tampa-poco-artesiano-6-polegadas';
update products set description = '<p>TAMPA PARA POÇO 125mm INTERNO.</p>
...
<p>FURO: 1 1/2"  MAX 49mm</p>' where slug = 'tampa-poco-artesiano-4-polegadas';
