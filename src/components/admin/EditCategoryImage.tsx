...
export default function EditCategoryImage({ category }: { category: Category }) {
  ...
  const dirty = imageUrl !== (category.image_url ?? "");
  ...
  return (
    <div className="flex items-start gap-2">
      <div
        ...
        className="flex h-12 w-12 shrink-0 cursor-pointer items-center justify-center overflow-hidden rounded-full border-2 border-dashed border-slate-300 bg-white transition-colors hover:border-brand-dark"
      ...
      <div className="min-w-0 flex-1">
        <input
          ...
          disabled={uploading}
          placeholder="Cole um link https://... ou clique no círculo para enviar"
